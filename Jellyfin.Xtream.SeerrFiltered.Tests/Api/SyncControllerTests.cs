...
using Jellyfin.Xtream.SeerrFiltered.Api;
...
namespace Jellyfin.Xtream.SeerrFiltered.Tests.Api;
...
public class SyncControllerTests
{
    ...
    public void DownloadLog_ReturnsFileResult_WithRedactedContent()
    {
        ...
        try
        {
            var logContent = "[2024-01-01 10:00:00] [INF] [Jellyfin.Xtream.SeerrFiltered] Sync started\n"
                + "[2024-01-01 10:00:01] [INF] [SomeOtherPlugin] This should be filtered out\n"
                + "[2024-01-01 10:00:02] [INF] [Jellyfin.Xtream.SeerrFiltered] Connecting to 192.168.1.100:8080\n";
            ...
            content.Should().Contain("Jellyfin.Xtream.SeerrFiltered");
