const XtreamLibraryConfig = {
    ...
    saveConfig: function () {
        ...
        ApiClient.getPluginConfiguration(this.pluginUniqueId).then(function (config) {
            ...
            config.OverseerrUrl = document.getElementById('txtOverseerrUrl').value.trim();
            config.OverseerrApiKey = document.getElementById('txtOverseerrApiKey').value.trim();
            config.EnableOverseerrFilter = document.getElementById('chkEnableOverseerrFilter').checked;
